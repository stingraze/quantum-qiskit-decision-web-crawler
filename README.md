...
Update 3/26/2026:
Created a judging script that takes input from the file generated by quantum-decision-crawler4.py and quantum-decision-crawler5.py and judges according to set criterias.
